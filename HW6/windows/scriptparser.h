              ...
              {   string strRet="";
                  ...
                  { 
                      ...
                      else
                      {
                              ...
                              if (i==5 && oper=="search") {
                                  if (str1.find("(") < str1.find_last_of(")") && str1.find_last_of(")") != string::npos && str1.find("'") != string::npos && str1.find("'") != str1.find_last_of("'") && str1.find(",") != string::npos && str1.find(",") != str1.find_last_of(","))
                                  {
