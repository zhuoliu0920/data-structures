        ...
        if (exp[k] == "+" || exp[k] == "*" || exp[k] == "(" || exp[k] == ")")
        {
            if (operators.isEmpty()) {
                ...
                while (operators.top() != "(") {
                    ...
                    temp[fl++].copy(*operands.top());
                    operands.pop();
                    if (operators.top() == "*") temp[fl].list_intersection(temp[fl-1], temp[fl-2],temp[fl-1].head, temp[fl-2].head);
                    if (operators.top() == "+") temp[fl].list_union(temp[fl-1], temp[fl-2], temp[fl-1].head, temp[fl-2].head);
                ...
                temp[fl++].copy(*operands.top());
                operands.pop();
                temp[fl].list_intersection(temp[fl-1], temp[fl-2],temp[fl-1].head, temp[fl-2].head);
                operands.push(&temp[fl]);
                fl++;
                operators.pop();
                operators.push(exp[k]);
