        ...
        if (exp[k] == "+" || exp[k] == "*" || exp[k] == "(" || exp[k] == ")")
        {
            if (operators.isEmpty()) {
                ...
                while (operators.top() != "(") {
                    ...
                    temp[fl++].copy(*operands.top());
                    operands.pop();
                    if (operators.top() == "*") temp[fl-2].list_intersection(temp[fl-1], temp[fl-2].head);
                    if (operators.top() == "+") temp[fl-2].list_union(temp[fl-1], temp[fl-1].head);
                    operands.push(&temp[fl-2]);
                    operators.pop();
                    if (operators.isEmpty()) {
                        delete[] temp;
                        return -1;
                ...
                temp[fl++].copy(*operands.top());
                operands.pop();
                temp[fl-2].list_intersection(temp[fl-1], temp[fl-2].head);
                operands.push(&temp[fl-2]);
                operators.pop();
                operators.push(exp[k]);
            }
